        ...
        {cart.map(product => {
            ...
            return (
                <div key={product.id} className="bg-gradient-to-r from-gray-50 to-gray-100 border-gray-200 shadow-md hover:shadow-lg rounded-lg mb-4 p-6 flex items-center justify-between transition-transform transform hover:scale-104 ">
                    <img src={imageUrl} alt={product.attributes.productName || "Sin título"} className="w-32 h-32 object-contain rounded-md border border-gray-200" />
                    <div className="ml-6">
                        ...
                        <p className="text-gray-800 font-semibold mt-4">
                            ARS {formatPrice(product.attributes?.price ? (product.attributes.price * product.quantity) : "N/A")}
                        </p>
